...
之前版本中，如果只修改代码中的硬编码字符串（如 `"开始游戏"` 改为 `"开始游戏1"`），补丁生成器会报告 "NO CHANGES DETECTED"。现在已修复，任何字符串修改都会被正确识别。
...
// v1.3.1: NO CHANGES DETECTED ❌
// v1.3.2: 1 modified class ✅
```

### 服务端更新

🆕 **补丁管理服务端** - 完整的 Web 管理后台
...
> 📖 **详细说明**: [CHANGELOG_STRING_FIX.md](CHANGELOG_STRING_FIX.md) | [patch-server/README.md](patch-server/README.md)
